  ...
  return (
    <section className="py-3xl px-md max-w-[88rem] mx-auto w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-lg">
        <Card variant="border" className="flex flex-col justify-between h-full">
          <p className="text-[16px] leading-relaxed text-[rgba(0,0,0,0.7)] italic">
          ...
          <div className="mt-lg pt-md border-t border-[rgba(0,0,0,0.06)]">
            <span className="text-[14px] font-semibold text-black block">
              Marcus Sterling
            </span>
            <span className="text-[11px] text-[rgba(0,0,0,0.55)] uppercase tracking-wider">
