      ...
      <div className="max-w-352 mx-auto px-lg flex flex-col gap-2xl">
        ...
        <div className="flex flex-col items-center text-center gap-xs max-w-200 mx-auto">
          ...
          <p className="text-[18px] text-[rgba(0,0,0,0.55)] font-medium leading-relaxed">
            Find quick answers to common queries regarding accounts, hashrate
            plans, ledger payouts, and security protocols.
          </p>
        ...
        {/* FAQ list */}
        <div className="flex flex-col gap-xl max-w-200 mx-auto w-full mt-sm">
              ...
              <div className="flex flex-col gap-xs">
                {category.items.map((item, index) => {
                  ...
                  return (
                    <Card
                      key={item.q}
                      className="p-md bg-white border border-[rgba(0,0,0,0.04)] rounded-2xl flex flex-col gap-sm transition-all"
                    >
                      <button
                      ...
                      >
                        <span className="flex items-center gap-xs">
                          <HelpCircle className="w-4 h-4 text-accent-foreground shrink-0" />{" "}
                          {item.q}
                        </span>
                        {isOpen ? (
