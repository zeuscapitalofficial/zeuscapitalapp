...
export function NavGroup({ label, labelKey, items }: SidebarNavGroup) {
  ...
  return (
    <SidebarGroup>
      {label && <SidebarGroupLabel>{t(labelKey || "", label)}</SidebarGroupLabel>}
      <SidebarMenu>
        {items.map((item) => {
                              ...
                              <SidebarMenuSubItem key={subItem.title}>
                                <SidebarMenuSubButton
                                  ...
                                  render={
                                    <a href={subItem.path}>
                                      {subItem.icon}
                                      <span>{t(subItem.i18nKey || "", subItem.title)}</span>
                                    </a>
                                  }
                                ></SidebarMenuSubButton>
                              </SidebarMenuSubItem>
