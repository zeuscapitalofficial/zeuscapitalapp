      ...
      <MessageScrollerProvider>
        <Popover open={isOpen} onOpenChange={setIsOpen}>
          ...
          <PopoverContent
            ...
            align="end"
            sideOffset={12}
            className="w-90 sm:w-105 p-0 border-none bg-transparent shadow-none ring-0 focus:outline-none relative flex flex-col gap-4"
          >
            <Card className="mx-auto h-135 w-full gap-0 overflow-hidden">
              {/* Header */}
